    ...
    return (
        <div className='page' id='projects'>
            ...
            <div className='projects-container'>
                ...
                <ProjectCard id={'incantations-card'} name={'Incantations for Spotify'} liveSite={'https://beamish-eclair-ddafee.netlify.app'} code={'https://github.com/aparks4/Incantations-for-Spotify'} description={'React | Express | Node.js | JWT'} />
